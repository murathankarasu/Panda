...
const translations = {
  tr: {
    ...
    'auth.google_register': 'Google ile Kayıt Ol',
    'auth.or': 'veya',
    'auth.name': 'İsim',
    ...
    'auth.login_button': 'GİRİŞ YAP',
    'auth.register_button': 'KAYIT OL',
    ...
    'auth.google_error': 'Google ile giriş yapılamadı. Lütfen tekrar deneyin.',
    'auth.email_in_use': 'Bu e-posta adresi zaten kullanımda.',
    'auth.wrong_password': 'Hatalı şifre.',
    'auth.user_not_found': 'Kullanıcı bulunamadı.',
    'auth.weak_password': 'Şifre en az 6 karakter olmalı.',
    'auth.general_error': 'Bir hata oluştu. Lütfen bilgilerinizi kontrol edin.',
  ...
  en: {
    ...
    'auth.email_in_use': 'This email address is already in use.',
    'auth.wrong_password': 'Incorrect password.',
    'auth.user_not_found': 'User not found.',
    'auth.weak_password': 'Password must be at least 6 characters long.',
    'auth.general_error': 'An error occurred. Please check your information.',
